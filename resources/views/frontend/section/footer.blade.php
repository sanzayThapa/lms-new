        ...
        <div class="row">
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    <a href="index.html">
                        <img src="{{asset('frontend/images/skillbest-logo.png')}}" alt="footer logo"
                            class="footer__logo" style="width: 200px; margin-left: -30px; margin-top: -40px;">
                    </a>
                    <ul class="generic-list-item pt-4">
                        <li><a href="tel:+977015909398">+977 01 5909398</a></li>
                        <li><a href="mailto:info@skillbest.com.np">info@skillbest.com.np</a></li>
                        <li>Kathmandu, Buddhanage, Nepal</li>
                    </ul>
    ...
    <div class="copyright-content py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <p class="copy-desc">&copy; 2026 SkillBest Nepal. All Rights Reserved.</p>
                </div><!-- end col-lg-6 -->
                <div class="col-lg-6">
