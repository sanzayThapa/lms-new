...
Route::middleware(['auth', 'verified', 'role:user'])->prefix('user')->name('user.')->group(function () {
    ...
    Route::get('/my/course', [\App\Http\Controllers\frontend\MyCourseController::class, 'myCourses'])->name('my.course');
    Route::get('/course/view/{id}', [\App\Http\Controllers\frontend\MyCourseController::class, 'courseViews'])->name('course.view');
});

// Fallback routes for when the 'user.' prefix is missing in route() calls
Route::middleware(['auth', 'verified', 'role:user'])->prefix('user')->group(function () {
    Route::get('/my/course/all', [\App\Http\Controllers\frontend\MyCourseController::class, 'myCourses'])->name('my.course');
    Route::get('/course/view/all/{id}', [\App\Http\Controllers\frontend\MyCourseController::class, 'courseViews'])->name('course.view');
});
